...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NUM_BRDG" -parent ${Page_0}
...
proc update_PARAM_VALUE.NUM_BRDG { PARAM_VALUE.NUM_BRDG } {
	# Procedure called to update NUM_BRDG when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUM_BRDG { PARAM_VALUE.NUM_BRDG } {
	# Procedure called to validate NUM_BRDG
	return true
}


proc update_MODELPARAM_VALUE.NUM_BRDG { MODELPARAM_VALUE.NUM_BRDG PARAM_VALUE.NUM_BRDG } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUM_BRDG}] ${MODELPARAM_VALUE.NUM_BRDG}
}
